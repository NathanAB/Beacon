  ...
  return (
    <PageTemplate>
      ...
      <p>
        ...
        continue to use Beacon's website if you do not accept all of the terms and conditions stated
        on this page.
      </p>
      <br />
      ...
      <p>
        ...
        and/or print pages from https://www.beacondates.com/ for your own personal use subject to
      ...
      <p>
        You must not:
        <ul>
          <li>Republish material from https://www.beacondates.com/</li>
          <li>Sell, rent or sub-license material from https://www.beacondates.com/</li>
          <li>Reproduce, duplicate or copy material from https://www.beacondates.com/</li>
          <li>
            Redistribute content from Beacon (unless content is specifically made for
            redistribution).
          </li>
        </ul>
      </p>
      ...
      <p>
        ...
        with the hyperlink outweighs the absence of Beacon; and (d) where the link is in the context
      ...
      <p>
        ...
        to our website, you must notify us by sending an e-mail to contact AT beacondates DOT com.
      ...
      <p>
        No use of Beacon's logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
      <br />
