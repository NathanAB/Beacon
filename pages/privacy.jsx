...
export default function PrivacyPage() {
  return (
    <PageTemplate>
      ...
      <p>
        Beacon is located at: <a href="https://www.beacondates.com">https://www.beacondates.com</a>
      </p>
      <br />

      <p>
        It is Beacon's policy to respect your privacy regarding any information we may collect while
        operating our website. This Privacy Policy applies to{' '}
        <a href="https://www.beacondates.com/">https://www.beacondates.com/</a> (hereinafter, "us",
        "we", or "https://www.beacondates.com/"). We respect your privacy and are committed to
      ...
      <p>
        ...
        language preference, referring site, and the date and time of each visitor request. Beacon's
        purpose in collecting non-personally identifying information is to better understand how
        Beacon's visitors use its website. From time to time, Beacon may release
        non-personally-identifying information in the aggregate, e.g., by publishing a report on
        trends in the usage of its website.
      </p>
      <p>
        Beacon also collects potentially personally-identifying information like Internet Protocol
        (IP) addresses for logged in users and for users leaving comments on
        https://www.beacondates.com/ blog posts. Beacon only discloses logged in user and commenter
      ...
      <p>
        ...
        Beacon gathers depends on the nature of the interaction. For example, we ask visitors who
      ...
      <p>
        ...
        the visitor's browser provides to the website each time the visitor returns. Beacon uses
        cookies to help Beacon identify and track visitors, their usage of
        https://www.beacondates.com/, and their website access preferences. Beacon visitors who do
        not wish to have cookies placed on their computers should set their browsers to refuse
        cookies before using Beacon's websites, with the drawback that certain features of Beacon's
