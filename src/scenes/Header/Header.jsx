    ...
    <AppBar position="fixed" color="inherit">
      <Toolbar className={classes.toolbar}>
        ...
        >
          <MenuList>
            {renderUserMenuItems()}
            <Link href="mailto:contact@beacondates.com" className={classes.menuLink}>
              <MenuItem className={classes.menuItem}>
                <Icon className={classes.menuIcon}>email</Icon>{' '}
                <span className={classes.menuItemText}>Contact us</span>
              </MenuItem>
            </Link>
            <Link href="https://forms.gle/ebaqVd2TMTw47RjW8" className={classes.menuLink}>
              <MenuItem className={classes.menuItem}>
                <Icon className={classes.menuIcon}>feedback</Icon>{' '}
                <span className={classes.menuItemText}>Give us Feedback</span>
              </MenuItem>
            </Link>
            <Link href="https://forms.gle/6pwD9m24Uz94PFXr8" className={classes.menuLink}>
